// @routes-hash 39fc3f8ec351b0b32148f0a66e5c0de5
...
import route71 from "./routes/production/storyboard/getState";
...
import route76 from "./routes/production/storyboard/setLock";
import route77 from "./routes/production/storyboard/setReviewState";
...
import route80 from "./routes/production/workbench/batchGeneratePrompt";
import route81 from "./routes/production/workbench/batchGenerateVideo";
import route82 from "./routes/production/workbench/checkVideoPrompt";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/storyboard/getState", route71);
  ...
  app.use("/api/production/storyboard/setLock", route76);
  app.use("/api/production/storyboard/setReviewState", route77);
  app.use("/api/production/storyboard/updateStoryboardUrl", route78);
  app.use("/api/production/workbench/addTrack", route79);
  app.use("/api/production/workbench/batchGeneratePrompt", route80);
  app.use("/api/production/workbench/batchGenerateVideo", route81);
  app.use("/api/production/workbench/checkVideoPrompt", route82);
