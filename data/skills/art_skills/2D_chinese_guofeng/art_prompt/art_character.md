...
{已确定物种与形态}角色四视图设定图，国风二次元，新国潮美学，日式动画渲染，赛璐璐平涂，细腻笔触，
character design sheet, character turnaround,
{角色描述对应的五官特征 - 由角色描述自然推导}, {整体气质}, 素颜状态,
{肤色}, 赛璐璐平涂, 皮肤通透发光, 细腻线条, 光影层次丰富,
{仅已明确的身高与体型，不用成人默认值}, {符合当前物种/年龄/形态的比例}, {已确定的体态},
{发色}{发长}, 细腻发丝清晰, {基础造型}, 无发饰,
{符合角色已有设定的服装与配饰；无衣着的非人类不添加人类衣裙},
...
|---|---|
| R1 | 必须为「素颜状态」 |
| R2 | 服装以已有设定为准，不按性别套用衣裙；非人类仅在设定要求时穿衣 |
| R3 | 保留角色已有的标志性配饰；不得无依据添加新配饰 |
| R4 | 必须指定「月白纯色背景」 |
| R5 | 必须指定「四视图一致性」 |
| R6 | 全身立像必须从头顶到脚底完整展示，严禁裁切 |
| R7 | 仅使用设定明确的身高，比例服从物种、年龄及形态，未知不补造成人身高或固定头身比 |
